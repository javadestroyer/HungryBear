...
public class SteakView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_steak_view);
        ...
        if(findViewById(R.id.fragment_container)!=null)
        {
            ...
            fragmentManager.beginTransaction().add(R.id.fragment_container, new SteakFragment()).commit();
        }
