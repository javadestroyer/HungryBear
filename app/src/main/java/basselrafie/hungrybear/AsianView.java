...
public class AsianView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asian_view);
        ...
        if(findViewById(R.id.fragment_container)!=null)
        {
            ...
            fragmentManager.beginTransaction().add(R.id.fragment_container, new AsianFragment()).commit();
        }
